...
var Module = (function () {
  ...
  //for create objects
  var geometry, geometro, ratio, geometry2, material,  mesh, sphere, axis, light, ambient, spotLight1;
  var material2 = [];
  var geometrical = [];
   var spheral;
...
var sphereGenerator = function(radial,meridiones,paralelos){

        geometry2 = new THREE.SphereGeometry( radial, meridiones, paralelos );
  ...
  var init = function (message) {
       ...
       spheral = {r: 600, s1: 10, s2:10}
        
      sphereGenerator(spheral.r, spheral.s1, spheral.s2);
